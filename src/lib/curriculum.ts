...
export const PATHS: Path[] = [
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { num: "03", title: "Install the server and run your first framework", blurb: "Download the latest artifact, open txAdmin, run a framework recipe, and join your own server.", slug: "artifacts-txadmin", tag: "Setup" },
          { num: "Bonus", title: "QBCore + txAdmin: complete server setup", blurb: "MariaDB, artifacts, txAdmin recipe, HeidiSQL - every step for a framework server.", slug: "qbcore-txadmin-first-server", tag: "Setup", bonus: true },
      ...
      {
        num: "A4",
        title: "Frameworks and admin commands",
        desc: "Reference guides you return to: how jobs are defined in QBCore, ESX, and Qbox, and every Quasar Store slash command you can type in chat.",
        lessons: [
          { num: "01", title: "Quasar Store: every slash command", blurb: "Every Quasar Store script's chat command, grouped by script, with who can run it.", slug: "quasar-store-commands", tag: "Reference", bonus: true },
          { num: "02", title: "QBCore jobs: add and edit jobs", blurb: "Define jobs and grades in qb-core/shared/jobs.lua, then assign them in game.", slug: "qbcore-jobs", tag: "Frameworks", bonus: true },
          { num: "03", title: "ESX jobs: add and edit jobs", blurb: "ESX keeps jobs in the database. Add them in the jobs and job_grades tables.", slug: "esx-jobs", tag: "Frameworks", bonus: true },
          { num: "04", title: "Qbox jobs: add and edit jobs", blurb: "Define jobs in qbx_core/shared/jobs.lua, then assign them in game.", slug: "qbox-jobs", tag: "Frameworks", bonus: true },
        ],
      },
    ],
  },
  {
    ...
    modules: [
      ...
      {
        num: "B11",
        title: "Framework guides: QBCore, ESX, Qbox",
        desc: "How each major framework works under your scripts: the core object, player data, money, jobs, items, commands, and callbacks. Read the one your server runs.",
        lessons: [
          { num: "01", title: "QBCore: how the framework works", blurb: "The Core object, PlayerData, server and client functions, commands, and callbacks.", slug: "qbcore-framework-guide", tag: "Frameworks", bonus: true },
          { num: "02", title: "ESX: how the framework works", blurb: "The shared object, xPlayer, money and jobs and items, commands, and callbacks.", slug: "esx-framework-guide", tag: "Frameworks", bonus: true },
          { num: "03", title: "Qbox: how the framework works", blurb: "The ox-based fork: direct exports, ox_inventory, ox_lib notify, commands, callbacks.", slug: "qbox-framework-guide", tag: "Frameworks", bonus: true },
        ],
      },
    ],
  },
