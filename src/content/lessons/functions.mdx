...
<FailureList
  items={[
    ...
    { symptom: "functiontest does nothing when a player runs it in chat", fix: "The restricted flag is true, so only the server console and aces may run it. Run functiontest from txAdmin Live Console, not the F8 chat box." },
  ]}
/>
