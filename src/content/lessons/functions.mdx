...
server_script 'server.lua'
    ...
    No `-- Lua 5.4 is the default runtime in 2026; the lua54 directive is no longer needed` line. The official manifest docs mark that directive as deprecated and say you do not need to enable it: as of June 2025 Lua 5.3 was removed and all Lua scripts now run on Lua 5.4, so you leave it out.
  </Step>
