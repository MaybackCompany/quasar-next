...
<FailureList
  items={[
    ...
    { symptom: "The command does nothing when a player runs it in chat", fix: "The restricted flag is true, so only the server console and aces may run roster or alias. Type them in the txAdmin Live Console, not the F8 chat box." },
  ]}
/>
