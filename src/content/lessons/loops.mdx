...
server_script 'server.lua'
    ...
    No `lua54 'yes'` line. As of June 2025 the FiveM docs mark that directive as deprecated: Lua 5.3 was removed and every resource now runs Lua 5.4, so the directive has no effect and you simply leave it out. (See the official manifest reference and the "Removal of Lua 5.3 support" announcement.)
  </Step>
