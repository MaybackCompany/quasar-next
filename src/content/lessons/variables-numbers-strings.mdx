...
resources/qu_variables_numbers_strings/
  ...
  <Step num={3} title="Write fxmanifest.lua" outcome="FiveM knows which files to load.">
    ...
    Same manifest shape as [your first Lua resource](/lessons/first-line-of-lua). There is no `lua54 'yes'` line: that setting was deprecated in June 2025 and is now ignored, because Lua 5.4 is the only Lua runtime FiveM ships. Leave it out.
  </Step>
